...
public class CalculationTest {
    ...
    void calculation_addition_success() {
        //Act
        double result= Calculation.calculate(1,2,"addition");
        //Assert
    ...
    void calculation_subtraction_success() {
        //Act
        double result= Calculation.calculate(10,2,"subtraction");
        //Assert
    ...
    void calculation_multiplication_success() {
        //Act
        double result= Calculation.calculate(10,2,"multiplication");
        //Assert
    ...
    void calculation_division_success() {
        //Act
        double result= Calculation.calculate(10,4,"division");
        //Assert
    ...
    void invalid_operator_throws_exception() {
        //Act & Assert
        Assertions.assertThrows(IllegalStateException.class,() -> Calculation.calculate(1,2,"s"));
    }
}
